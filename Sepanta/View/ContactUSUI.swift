...
class ContactUSUI: NSObject, UITextFieldDelegate, SFSafariViewControllerDelegate {
    ...
    func showContactInfo() {
        ...
        cursurY += shopView.frame.height + marginY/2
        ...
        cursurY += addressView.frame.height + marginY/2
        ...
        cursurY += telView.frame.height + marginY/2
        ...
        cursurY += webView.frame.height + marginY/2
