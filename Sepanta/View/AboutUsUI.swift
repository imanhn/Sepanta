...
class AboutUsUI: NSObject, SFSafariViewControllerDelegate {
    ...
    func showAboutUs(_ avc: AboutUsViewController) {
        ...
        cursurY += logo.frame.height + 0//+ marginY
        ...
        cursurY += logo_text.frame.height + 0//+ marginY
        ...
        cursurY += logo_text.frame.height + marginY
        ...
        cursurY += sepantaLabel.frame.height + marginY
        ...
        cursurY += cardImage.frame.height + 10
        ...
        cursurY += cardLabel.frame.height + marginY
        ...
        cursurY += ipsLabel.frame.height +  marginY
        ...
        cursurY += aBut.frame.height + 10//marginY
        ...
        cursurY += siteLabel.frame.height +  marginY
