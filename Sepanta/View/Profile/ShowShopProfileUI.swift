//
//  ShowShopProfileUI.swift
//  Sepanta
//
//  Created by Iman on 8/7/1398 AP.
...
class ShowShopProfileUI: NSObject, UICollectionViewDelegateFlowLayout {
    ...
    func bindCollectionView() {
        ...
        if LoginKey.shared.role == "Shop" {
            ...
            self.posts.bind(to: collectionView.rx.items(cellIdentifier: "shopcell")) { [weak self] _, model, cell in
    ...
    @objc func showMyCards(_ sender : Any) {
        ...
        var i = 0
        for aCardData in NetworkManager.shared.userProfileObs.value.cards {
