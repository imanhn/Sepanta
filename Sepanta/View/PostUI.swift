...
class PostUI {
    ...
    func buildPostView(With innerPost: Post) {
        ...
        self.cursurY += postView.frame.height + self.marginY
        ...
        self.cursurY += titleLabelHeight + self.marginY
        ...
        self.cursurY += contentLabelHeight + self.marginY
        ...
        cursorX += buttonDim + self.marginX/2
        ...
        cursorX += likeNoWidth + (self.marginX * 2)
        ...
        self.cursurY += buttonDim + self.marginY*2
        ...
        sendCommentButton.imageEdgeInsets = UIEdgeInsets(top: sendCommentButton.frame.width*2/7, left: sendCommentButton.frame.width*2/7, bottom: sendCommentButton.frame.width*2/7, right: sendCommentButton.frame.width*2/7)
        ...
        cursorX += sendCommentButton.frame.width + self.marginX/2
        ...
        self.cursurY += self.marginY + rowRect.height
    }
    ...
    func buildCommentView(With comments: [Comment]) {
        ...
        for aComment in comments {
            ...
            commentCursurY += self.marginY/3 + profilePicturedim
            ...
            commentCursurY += self.marginY + commentHeight
        }
